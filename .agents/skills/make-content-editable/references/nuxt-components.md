...
Nuxt automatically imports components from the `app/components/` (Nuxt 4) directory. No manual registration is required. Components are named based on their path:
