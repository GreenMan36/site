  ...
  <ContentContainer>
    ...
    <div class="text-container">
      ...
      <p>
        ...
        professionals uit de branche. De vereniging heeft ook een actieve rol in de organisatie van evenementen, zoals
        minimaal 1 maal per jaar een studiereis naar beurzen door Europa en hackathons.
      </p>

      <div class="stats-row">
        <div class="stat-card">
          <span class="stat-card__number">300+</span>
          <span class="stat-card__label">Leden</span>
        </div>
        <div class="stat-card">
          <span class="stat-card__number">HU</span>
          <span class="stat-card__label">Hogeschool Utrecht</span>
        </div>
        <div class="stat-card">
          <span class="stat-card__number">ICT</span>
          <span class="stat-card__label">Voor & door studenten</span>
        </div>
      </div>
    </div>
    ...
    <div class="text-container">
      ...
      <p>
        Dit waren de wijze woorden van onze voorzitter William die aan het praten was tegen Nigel onze secretaris.
        Diezelfde dag werd Olivier door William benaderd of hij het ook leuk lijkt om ICT weer gezellig te maken. Het
        enige wat er nog ontbrak was iemand die zich goed kon vinden in de cijfers. De zoektocht duurde niet lang. We
        hadden al snel iemand gevonden die uitstekend kan boekhouden en zo met Sander onze penningmeester erbij hadden
        we een hecht bestuur gevormd.
      </p>
    </div>
  </ContentContainer>
</template>
...
.stat-card__number {
  font-family: 'Indicium-font', serif;
  font-size: 1.9rem;
  line-height: 1;
